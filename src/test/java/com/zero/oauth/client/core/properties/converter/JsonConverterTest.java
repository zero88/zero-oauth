...
public class JsonConverterTest {
    ...
    public void test_ResponseProp_ExchangeToken_JsonConverter() {
        ...
        PropertyStore<IPropertyModel> deserialize = new JsonConverter<>(responseProperties).deserialize(body, FlowStep.EXCHANGE_TOKEN);
        ...
        assertEquals(EXPIRES_IN, ((Double) deserialize.get(OAuth2ResponseProp.EXPIRES_IN.getName()).getValue()).intValue());
