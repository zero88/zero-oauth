...
public enum SignatureMethod {
    ...
    /**
     * {@code RSA-SHA1} signature method uses the RSASSA-PKCS1-v1_5 signature algorithm as defined in
     * [RFC3447] section 8.2 (more simply known as PKCS#1), using SHA-1 as the hash function for
     * EMSA-PKCS1-v1_5. It is assumed that the Consumer has provided its RSA public key in a verified way to
     * the Service Provider, in a manner which is beyond the scope of this specification.
     *
     * @see <a href="https://tools.ietf.org/html/rfc5849#section-3.4.3">[RFC5849 - OAuth1] RSA-SHA1</a>
     * @see <a href="https://tools.ietf.org/html/rfc8017>[RFC8017] RSA Cryptography Specifications Version
     *         2.2</a>
     */
    RSA_SHA1("RSA-SHA1", "SHA1withRSA"),

    /**
     * The PLAINTEXT method does not provide any security protection and SHOULD only be used over a secure
     * channel such as HTTPS. It does not use the Signature Base String.
     *
