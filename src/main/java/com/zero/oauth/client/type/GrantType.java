...
public enum GrantType {
    ...
    IMPLICIT_DEPRECATED("token", "authorization_code",
                        Arrays.asList(FlowStep.AUTHORIZE, FlowStep.EXCHANGE_TOKEN,
                                      FlowStep.REVOKE_TOKEN, FlowStep.ACCESS_RESOURCE)),
     ...
     */
    PASSWORD(null, "password", Arrays.asList(FlowStep.EXCHANGE_TOKEN, FlowStep.REVOKE_TOKEN,
                                             FlowStep.ACCESS_RESOURCE)),
    ...
    CLIENT_CREDENTIALS(null, "client_credentials",
                       Arrays.asList(FlowStep.EXCHANGE_TOKEN, FlowStep.REVOKE_TOKEN,
                                     FlowStep.ACCESS_RESOURCE)),

    /**
     * If the authorization server issued a refresh token to the client, client is able to issue a
