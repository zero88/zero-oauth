...
interface IOAuth2PropertyMatcher extends IPropertyModel {
     ...
     *
     * @param grantType
     *        OAuth Grant Type contains property
     * @param step
     ...
     * @see FlowStep
     */
    public default <T extends OAuth2PropertyModel> T declare(GrantType grantType, FlowStep step) {
     ...
     */
    public <T extends IPropertyModel> T match(GrantType grantType);
