 ...
 */
@Getter
public final class OAuth1RequestProp extends PropertyModel {

    /**
     * Realm
     */
    public static final OAuth1RequestProp REALM = new OAuth1RequestProp("realm").addStep(FlowStep.INIT).require();

    /**
     * An absolute URI back to which the server will redirect the resource owner when the Resource Owner Authorization
     * step is completed.
     */
    public static final OAuth1RequestProp REDIRECT_URI = new OAuth1RequestProp("oauth_callback").addStep(FlowStep.INIT)
                                                                                                .require();

    /**
     * The public identifier for the application, obtained when the developer first registered the application.
     */
    public static final OAuth1RequestProp CONSUMER_KEY = new OAuth1RequestProp("oauth_consumer_key").require();

    /**
     * The name of the signature method used by the client to sign the request.
     */
    public static final OAuth1RequestProp SIGNATURE_METHOD = new OAuth1RequestProp("oauth_signature_method");
    /**
     * The client generates a signature and use it together with {@link #SIGNATURE_METHOD}.
     */
    public static final OAuth1RequestProp SIGNATURE = new OAuth1RequestProp("oauth_signature");
     ...
     * requests.
     */
    public static final OAuth1RequestProp TIMESTAMP = new OAuth1RequestProp("oauth_timestamp").require();
    /**
     ...
     * non-secure channel.
     */
    public static final OAuth1RequestProp NONCE = new OAuth1RequestProp("oauth_nonce").require();

    /**
     * If present, value MUST be {@code 1.0}
     */
    public static final OAuth1RequestProp VERSION = new OAuth1RequestProp("oauth_version").defaultValue("1.0");

    /**
     * The temporary credentials token,
     */
    public static final OAuth1RequestProp REQUEST_TOKEN = new OAuth1RequestProp("oauth_token").addStep(FlowStep.AUTHORIZE)
                                                                                              .addStep(FlowStep.ACCESS_TOKEN)
                                                                                              .require();
    /**
     * The verification code.
     */
    public static final OAuth1RequestProp OAUTH_VERIFIER = new OAuth1RequestProp("oauth_verifier").addStep(FlowStep.AUTHORIZE)
                                                                                                  .addStep(FlowStep.ACCESS_TOKEN)
                                                                                                  .require();
     ...
     */
    public static final OAuth1RequestProp ACCESS_TOKEN = new OAuth1RequestProp("oauth_token").addStep(FlowStep.ACCESS_RESOURCE)
                                                                                             .require();
    ...
    public OAuth1RequestProp addStep(FlowStep step) {
