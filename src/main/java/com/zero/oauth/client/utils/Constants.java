...
public final class Constants {
    ...
    public static final String OAUTH_RANDOM_TEXT_MAX_LEN_PROPERTY =
        "z.oauth.sec.algo.random_token.text.max_len";
    public static final String OAUTH_RANDOM_TEXT_SYMBOL_PROPERTY =
        "z.oauth.sec.algo.random_token.text.symbols";
