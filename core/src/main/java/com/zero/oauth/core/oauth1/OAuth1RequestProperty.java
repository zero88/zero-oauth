...
public final class OAuth1RequestProperty extends OAuth1PropertyModel {
    ...
    public static final OAuth1RequestProperty CONSUMER_KEY =
        new OAuth1RequestProperty("oauth_consumer_key").declare(FlowStep.REQUEST).declare(FlowStep.EXCHANGE_TOKEN)
     ...
     * <p>
     * The {@code shared-secret} will be used with {@code temp credential} to combine a {@code OAuth signature} for
     * identify request.
     *
    ...
    public static final OAuth1RequestProperty CONSUMER_SECRET =
        new OAuth1RequestProperty("oauth_consumer_secret").declare(FlowStep.REQUEST).declare(FlowStep.EXCHANGE_TOKEN)
                                                          .declare(FlowStep.ACCESS_RESOURCE);

    /**
     * The getName of the signature method used by the client to sign the request.
     *
     * @see SignatureMethod
     */
    public static final OAuth1RequestProperty SIGNATURE_METHOD =
        new OAuth1RequestProperty("oauth_signature_method").declare(FlowStep.REQUEST).declare(FlowStep.EXCHANGE_TOKEN)
                                                           .declare(FlowStep.ACCESS_RESOURCE)
    ...
    public static final OAuth1RequestProperty SIGNATURE =
        new OAuth1RequestProperty("oauth_signature").declare(FlowStep.REQUEST).declare(FlowStep.EXCHANGE_TOKEN)
                                                    .declare(FlowStep.ACCESS_RESOURCE);

    /**
     * The timestamp is expressed in the number of seconds since January 1, 1970 00:00:00 GMT. The timestamp value MUST
     * be a positive integer and MUST be equal or greater than the timestamp used in previous requests.
     */
    public static final OAuth1RequestProperty TIMESTAMP =
        new OAuth1RequestProperty("oauth_timestamp").declare(FlowStep.REQUEST).declare(FlowStep.EXCHANGE_TOKEN)
                                                    .declare(FlowStep.ACCESS_RESOURCE);
    ...
    public static final OAuth1RequestProperty OAUTH_VERIFIER =
        new OAuth1RequestProperty("oauth_verifier").declare(FlowStep.AUTHORIZE).declare(FlowStep.EXCHANGE_TOKEN);
