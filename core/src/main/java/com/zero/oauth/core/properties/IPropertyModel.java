...
public interface IPropertyModel {
    ...
    /**
     * Property's getName is mandatory and unique, that declares a key in HTTP Request/Response parameters/header or
     * body.
     *
     * @return {@code property's getName}
     */
    String getName();
     ...
     * @param func A computed function
     * @return {@code this}
     */
